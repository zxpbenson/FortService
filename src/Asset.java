...
public class Asset {
    ...
    public static void main(String[] args){
        //System.out.println(getAccountPassword("Asset_0058B6BA0","rtbridge"));
    ...
    private static boolean assetTypeMatch(String assetType){
        if("linux".equalsIgnoreCase(assetType))return true;
        if("unix".equalsIgnoreCase(assetType))return true;
        if("aix".equalsIgnoreCase(assetType))return true;
        if("solaris".equalsIgnoreCase(assetType))return true;
        return false;
    }
